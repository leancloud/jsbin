...
// Sort out the port.
(function () {
  var port = process.env.PORT || process.env.LC_APP_PORT;
...
app.connect = function (callback) {
  ...
  app.configure(function () {
    ...
    app.use(filteredCookieSession(['user.settings', 'passport', 'user.email', 'user.github_id', 'user.github_token', 'user.dropbox_token', 'user.dropbox_id', 'user.flagged', 'user.bincount', 'user.api_key', 'user.key', 'user.id', 'user.pro', 'user.embed']));
